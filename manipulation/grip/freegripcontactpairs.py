...
class FreegripContactpairs(object):
    ...
    def loadObjModel(self, ompath, numOfSamplingPoints, object_scale):
        ...
        self.sampleObjModel(numpointsoververts=numOfSamplingPoints)
    ...
    def sampleObjModel(self, numpointsoververts=30):
        """
    ...
    def removeBadSamples(self, mindist=7, maxdist=20):
        '''
    ...
    def clusterFacetSamplesRNN(self, reduceRadius=5):
        """
    ...
    def planContactpairs(self, torqueresist = 50, fgrtipdist = 100):
        """
