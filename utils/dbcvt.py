...
def v6ToStr(v6):
    """
    convert a vbase6 vector to a string like v0,v1,v2,v3,v4,v5

    :param v6:
    :return:
    """

    return ','.join(str(e) for e in v6)

def strToV6(dbstr):
    """
    convert a string like v0,v1,v2,v3,v4,v5 to a v6
    ...
    exx = dbstr.split(',')
    exxdecimal = map(float, exx)
    assert(len(exxdecimal) is 6)
    return [exxdecimal[0], exxdecimal[1], exxdecimal[2], exxdecimal[3], exxdecimal[4], exxdecimal[5]]